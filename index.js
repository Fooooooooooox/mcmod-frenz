...
var bot = mineflayer.createBot({
  ...
  username: 'bc',
  port: 53663,                // only set if you need a port that isn't 25565
...
bot.on('spawn', ()=>{moveWithNearestPlayer(bot)} )

bot.on('chat', (username, message)=>{chatWithGPT(username, message, bot)})
